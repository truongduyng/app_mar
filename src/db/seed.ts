...
const tinystepsSlides: SlideRow[] = [
  ...
  // vi group — Vietnamese screenshots; vi-prefixed slide keys avoid collisions with default group
  {
    ...
    device: "iphone",
    slideKey: "vi-hero",
    componentKey: "TinyStepsViSlide1",
    sortOrder: 0,
  },
  {
    groupKey: "tinysteps:vi",
    device: "iphone",
    slideKey: "vi-journal",
    componentKey: "TinyStepsViSlide2",
    sortOrder: 1,
  },
  {
    groupKey: "tinysteps:vi",
    device: "iphone",
    slideKey: "vi-ai-chat",
    componentKey: "TinyStepsViSlide3",
    sortOrder: 2,
  },
  {
    groupKey: "tinysteps:vi",
    ...
    componentKey: "TinyStepsViSlide4",
    sortOrder: 3,
  },
  {
    groupKey: "tinysteps:vi",
    ...
    componentKey: "TinyStepsViSlide5",
    sortOrder: 4,
  },
  {
    groupKey: "tinysteps:vi",
    ...
    componentKey: "TinyStepsViSlide6",
    sortOrder: 5,
  },
];
